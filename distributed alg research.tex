...
% Should this be a lemma or a theorem?
...
In the staggered activation case, a given node $u$ that receives a message $m$ at round $r$ will eventually send a confirmation message to its parent. 
\end{lemma}
\begin{proof}
